...
local Vector3 = ffi.typeof("struct Heartbeat_Vector3")
...
local const = {
	...
	front = function() return Vector3( 0, 0, 1) end,
}
...
local methods = {
	...
	getAngle = function(self)
		return self:getAngleTo(Vector3(1, 0, 0))
	end,
	...
	is = function(value) return ffi.istype(Vector3, value) end
}
...
local meta = {
	...
	-- Equality
	__eq = function(a, b)
		if Vector3.is(a) ~= Vector3.is(b) then return false end
